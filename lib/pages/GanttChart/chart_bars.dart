...
class DependencyLine extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    if (depIssuesNumbers.isNotEmpty) {
      List<Issue> depIssues = depIssuesNumbers
          .map<Issue>((e) => allIssue.singleWhere((el) => el.number == e))
          .toList();
      for (var el in depIssues) {
        int indexDif = allIssue.indexOf(issue) - allIssue.indexOf(el);

        if (indexDif > 0) {
          double issueLeft = GanttChartController.instance
                      .calculateDistanceToLeftBorder(issue.startTime!) *
              ...
              (GanttChartController.instance.isPanStartActive ||
                  ...
                  ? issue.width
                  : 0);
          double depIssueLeft = GanttChartController.instance
                      .calculateDistanceToLeftBorder(el.startTime!) *
                  GanttChartController.instance.chartViewWidth /
                  GanttChartController.instance.viewRangeToFitScreen! +
              (GanttChartController.instance.isPanStartActive ||
                      GanttChartController.instance.isPanMiddleActive
...
class ChartBars extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ListView.builder(
          physics: gantChartController.isAltPressed
          ...
          itemBuilder: (listContext, index) {
            return ChangeNotifierProvider<Issue>.value(
              value: data[index],
              child:
                  Consumer<Issue>(builder: (issuesContext, issuesValue, child) {
                issuesValue.remainingWidth = GanttChartController.instance
                    .calculateRemainingWidth(
                        issuesValue.startTime!, issuesValue.endTime!);
                    ...
                    children: [
                      Positioned(
                        ...
                        child: CustomPaint(
                          ...
                          child: SizedBox(
                            width: GanttChartController.instance
                      ...
                      GestureDetector(
                        onTap: () {
                          GanttChartController.instance
                              .issueSelect(issuesValue, data);
                        },
                        child: Listener(
                          onPointerDown: (event) async {
                            GanttChartController.instance.contextIssueIndex =
                                index;

                            if (event.kind == PointerDeviceKind.mouse &&
                                event.buttons == kSecondaryMouseButton &&
                                !issuesValue.selected) {
                              GanttChartController.instance.issueSelect(
                                  issuesValue,
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                                color: issuesValue.startTime!.compareTo(
                                ...
                                border: Border.all(
                                  color: Colors.yellow,
                                  width: 1,
                                  style: issuesValue.selected
                                      ? BorderStyle.solid
                                      : BorderStyle.none,
                                )),
                            height: 30.0,
                            width: issuesValue.remainingWidth! *
                                    GanttChartController
                                        .instance.chartViewWidth /
                                    GanttChartController
                                        .instance.viewRangeToFitScreen! -
                                (GanttChartController.instance.isPanStartActive
                                    ? issuesValue.width
                                    : GanttChartController
                                            .instance.isPanEndActive
                                        ? -issuesValue.width
                                        : 0),
                            margin: EdgeInsets.only(
                                left: GanttChartController.instance
                                            .calculateDistanceToLeftBorder(
                                                issuesValue.startTime!) *
                                        GanttChartController
                                            .instance.chartViewWidth /
                                        GanttChartController
                                            .instance.viewRangeToFitScreen! +
                                    (GanttChartController.instance.isPanStartActive ||
                                        ...
                                        ? issuesValue.width
                                        : 0),
                                right: GanttChartController.instance
                                            .calculateDistanceToRightBorder(issuesValue.endTime!) *
                                        GanttChartController.instance.chartViewWidth /
                                        GanttChartController.instance.viewRangeToFitScreen! -
                                    (GanttChartController.instance.isPanEndActive || GanttChartController.instance.isPanMiddleActive ? issuesValue.width : 0),
                                top: index == 0 ? 4.0 : 2.0,
                                bottom: index == data.length - 1 ? 4.0 : 2.0),
                            child: issuesValue.processing
                                ? Container(
                                ...
                                : Row(
                                    children: [
                                      GestureDetector(
                                        ...
                                        onPanDown: (details) {
                                          GanttChartController.instance
                                              .onIssueStartPan(PanType.start,
                                                  details.globalPosition.dx);
                                        },
                                        onPanCancel: () {
                                          GanttChartController.instance
                                              .onIssuePanCancel(PanType.start);
                                        },
                                        onPanEnd: (details) async {
                                          GanttChartController.instance
                                              .onIssueEndPan(PanType.start);
                                        },
                                        child: Container(
                                          width: (issuesValue.remainingWidth! *
                                                                  GanttChartController
                                      ...
                                      Expanded(
                                        child: GestureDetector(
                                          ...
                                          onPanDown: (details) {
                                            GanttChartController.instance
                                                .onIssueStartPan(PanType.middle,
                                                    details.globalPosition.dx);
                                          },
                                          onPanCancel: () {
                                            GanttChartController.instance
                                      ...
                                      GestureDetector(
                                        ...
                                        onPanDown: (details) {
                                          GanttChartController.instance
                                              .onIssueStartPan(PanType.end,
                                                  details.globalPosition.dx);
                                        },
                                        onPanCancel: () {
                                          GanttChartController.instance
                                              .onIssuePanCancel(PanType.end);
                                        },
                                        onPanEnd: (details) async {
                                          GanttChartController.instance
                                              .onIssueEndPan(PanType.end);
                                        },
                                        child: Container(
                                          width: (issuesValue.remainingWidth! *
                                                                  GanttChartController
